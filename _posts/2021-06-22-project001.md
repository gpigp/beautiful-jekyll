...
<p>
    <img src="assets/post1-img/detect01.jpg" width="300px" height="500px" title="px(픽셀) 크기 설정" alt="detect_cat01"/>
    <img src="assets/post1-img/detect02.jpg" width="300px" height="500px" title="px(픽셀) 크기 설정" alt="detect_cat02"/>
</p>
