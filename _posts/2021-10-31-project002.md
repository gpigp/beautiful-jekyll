...
<h6>.dict file is needed to run gatk. </h6>
```
...
```
<br>
<span style="color: #2D3748; background-color: #fff5b1">2022.05.02.fixed</span>
<br>
...
run_deepvariant --model_type=WGS \
  --ref=/home/Lab_Project_002/calJac4.fa \
  --reads=/home/Lab_Project_002/SRR7050660_recal_reads.bam \
  --output_vcf=/home/Lab_Project_002/output/marmoset_VCF \
  --output_gvcf=/home/Lab_Project_002/output/marmoset_GVCF \
  --num_shards=$(nproc) \
  --logging_dir=/home/Lab_Project_002/log \
  --dry_run=false
```
